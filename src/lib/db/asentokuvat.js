// Kehokorjaamo-App — Asentokuvat (KA1)
//
// 4 kuvaa per käynti (edesta/takaa/vasen/oikea), TensorFlow.js MoveNet-
// keypointit ja niistä lasketut anatomiset kulmat.
//
// Tämä moduuli sisältää:
//   - haeAsentokuvat / tallennaAsentokuva / poistaAsentokuva — perusoperaatiot
//   - paivitaAsentokuvanKeypointit — MoveNet-tuloksen tallennus
//   - paivitaAsentokuvanKulmat — laskettujen kulmien tallennus
//   - paivitaKeypointitJaKulmat — molemmat samassa transaktiossa
//     (KA4: vältetään race kun käyttäjä raahaa nopeasti)
//   - haeAsiakkaanAsentokuvaHistoria — käynneittäin ryhmiteltynä Vertailu-
//     välilehteen ja aikajanaan
//
